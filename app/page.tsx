              ...
              >
                ...
                <CardContent>
                  ...
                  <p className="text-xs font-mono text-terminal-text-muted mt-1">
                    <span className="text-terminal-green">{stat.change}</span>{" "}
                    from last month
                  </p>
                </CardContent>
              </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Your most active learning modules
                  </CardDescription>
                </div>
          ...
          <CardContent>
            <div className="rounded-md bg-terminal-darker/80 border border-terminal-green/20 p-4 font-mono text-sm space-y-1 max-h-48 overflow-y-auto">
              <p className="text-terminal-text-muted">
                ...
                14:32:15] System initialized successfully
              </p>
              <p className="text-terminal-text-muted">
                <span className="text-terminal-green">$</span> [2026-01-23
                14:32:16] Connected to database: PostgreSQL 16.1
              </p>
              <p className="text-terminal-text-muted">
                <span className="text-terminal-green">$</span> [2026-01-23
                14:32:17] Loaded 42 active courses
              </p>
              <p className="text-terminal-text-muted">
                <span className="text-terminal-green">$</span> [2026-01-23
                14:32:18] Authenticated 234 active users
              </p>
              <p className="text-terminal-text-muted">
                <span className="text-blue-400">$</span> [2026-01-23 14:33:42]
                New enrollment: Alice Johnson → Advanced JavaScript
              </p>
              <p className="text-terminal-text-muted">
                <span className="text-terminal-green">$</span> [2026-01-23
                14:35:12] Assignment submitted: Final Project by Bob Smith
              </p>
              <p className="text-terminal-text-muted">
                <span className="text-yellow-400">$</span> [2026-01-23 14:36:05]
                Warning: Email service latency detected
              </p>
              <p className="text-terminal-text-muted">
                <span className="text-terminal-green">$</span> [2026-01-23
                14:37:23] Course completed: Carol White (87.5% grade)
              </p>
            </div>
          </CardContent>
        </Card>
